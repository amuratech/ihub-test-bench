...
//    UIElement linkStaging = new UIElement(UIType.Link, UILocatorType.Xpath,"//*[@id=\"client_development_task_website_development_output_staging_link\"]");
    ...
    UIElement start = new UIElement(UIType.Link, UILocatorType.Xpath,"//*[@id=\"page-content-wrapper\"]/div[2]/div/div[1]/div[1]/div/div[4]/div/div/ul/li[2]/ul/li[1]");//*[@id="page-content-wrapper"]/div[2]/div/div[1]/div[1]/div/div[4]/div/div/ul/li[1]/ul/li[1]/a
