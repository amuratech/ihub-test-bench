...
public class ExportFormatPage extends BasePage {
    ...
    UIElement exportFormats = new UIElement(UIType.Link, UILocatorType.Xpath,"//*[@id=\"sidebar-wrapper\"]/ul/li[10]/a");
    UIElement userExportFormats = new UIElement(UIType.Link, UILocatorType.Xpath,"//*[@id=\"sidebar-wrapper\"]/ul/li[6]/a");
    UIElement addExportFormat = new UIElement(UIType.Button, UILocatorType.Xpath,"//*[contains(text(),'Add a export format')]");
    UIElement name = new UIElement(UIType.TextBox, UILocatorType.Xpath,"//*[@id=\"export_format_name\"]");
    ...
    UIElement generateReportLink = new UIElement(UIType.Link, UILocatorType.Xpath,"//*[@id=\"page-content-wrapper\"]/div[2]/div/div/table/tbody/tr[1]/td[5]/div/a/i");
    UIElement dateRange = new UIElement(UIType.TextBox, UILocatorType.Xpath,"//*[@id=\"new_export\"]/div[2]/div[1]/div/div/div[1]");
    ...
    UIElement taskExports = new UIElement(UIType.Button, UILocatorType.Xpath,"//*[@id=\"exportFormatLinks\"]/li[1]/a");//*[@id="page-content-wrapper"]/div[1]/div[2]/ul/li/a
    UIElement creator = new UIElement(UIType.Button, UILocatorType.Xpath,"//*[@id=\"new_export\"]/div[3]/div/div[8]/div/div/div[1]");//*[@id="page-content-wrapper"]/div[1]/div[2]/ul/li/a
    UIElement assignment = new UIElement(UIType.Button, UILocatorType.Xpath,"//*[@id=\"new_export\"]/div[3]/div/div[9]/div/div/div[1]");//*[@id="page-content-wrapper"]/div[1]/div[2]/ul/li/a
    ...
    public void clickTaskExports() {
        tDriver.myclicking(taskExports);
    }

    public void selectTheCreator() {
        tDriver.myTaskExportCreator(creator);
    }

    public void selectTheAssignment() {
        tDriver.myTaskExportAssignment(assignment);
    }
}
