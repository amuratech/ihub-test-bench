...
public class WebMailerOutputPage extends BasePage{
    ...
    UIElement submit = new UIElement(UIType.Button, UILocatorType.Xpath,"//*[@id=\"new_client_development_mailer_output\"]/div[3]/div/div/input");
    ...
    UIElement output = new UIElement(UIType.Button, UILocatorType.Xpath,"//*[@id=\"new_client_development_review\"]/div[8]/div/div/a[4]");
