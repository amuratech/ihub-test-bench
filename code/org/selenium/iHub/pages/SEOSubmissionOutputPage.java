...
public class SEOSubmissionOutputPage extends BasePage {
    ...
    UIElement saveOutput = new UIElement(UIType.TextBox, UILocatorType.Xpath,"//*[@id=\"new_client_seo_submission_output\"]/div[3]/div/div/input");
    UIElement tags = new UIElement(UIType.TextBox, UILocatorType.Xpath,"//*[@id=\"client_seo_review_questions_attributes_0_answer\"]");
    UIElement rateOutput = new UIElement(UIType.TextBox, UILocatorType.Xpath,"//*[@id=\"new_client_seo_review\"]/div[3]/div/div/a[4]");
