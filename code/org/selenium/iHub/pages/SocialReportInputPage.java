...
public class SocialReportInputPage extends BasePage {
    ...
    UIElement startDate = new UIElement(UIType.TextBox, UILocatorType.Xpath,"//*[@id=\"client_social_report_report_start_date\"]");
    UIElement endDate = new UIElement(UIType.TextBox, UILocatorType.Xpath,"//*[@id=\"client_social_report_report_end_date\"]");
