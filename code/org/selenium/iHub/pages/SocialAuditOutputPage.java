...
public class SocialAuditOutputPage extends BasePage{
    ...
    UIElement submit = new UIElement(UIType.Link, UILocatorType.Xpath,"//*[@id=\"new_client_social_audit_output\"]/div[2]/div/div/input");
    ...
    UIElement rateOutput = new UIElement(UIType.Link, UILocatorType.Xpath,"//*[@id=\"new_client_social_review\"]/div[6]/div/div/a[4]");
