...
public class ProjectExportPage extends BasePage {
    ...
    public void selectDateRangeFieldProductExports() {
        tDriver.myProjectExportDateRange(dateRangeField);
    }

    public void selectStage() {
        tDriver.myProjectExportStage(stage);
    }

    public void selectClient() {
        tDriver.myProjectExportClient(client);
    }

    public void selectCreator() {
        tDriver.myProjectExportCreator(creator);
    }
